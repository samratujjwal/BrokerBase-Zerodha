            ...
            <div className="container">
                ...
                <div className="row">
                    <div className="col-6">
                        ...
                        <p>When trading at BrokerBase, STT/CTT can be a lot more than the brokerage we charge. Important to keep a tab.</p>
                        ...
                        <h4>Call & trade</h4>
                        <p>Additional charges of ₹50 per order for orders placed through a dealer at BrokerBase including auto square off orders.</p>
                        <h4>Stamp charges</h4>
